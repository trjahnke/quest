# Borrowed network instructions from the following repo https://github.com/jimmysawczuk/terraform-fargate-tutorial/blob/main/network.tf 
# This was done simply to get the network to work. As my knowledge of terraform-network is limited at the moment, a future task to learn terraform-networking.
